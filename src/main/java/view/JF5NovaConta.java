 ...
 * @author iuryi
 */
public class JF5NovaConta extends javax.swing.JFrame {

    ArrayList<Conta> Contas;
    ArrayList<Cliente> ListaCliente;
    double saldo;
    Cliente novaContaCliente;
    ...
    public JF5NovaConta(ArrayList<Cliente> ListaCliente, ArrayList<Conta> Contas) {
    ...
    private void TableSelecionaClienteNovaContaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableSelecionaClienteNovaContaMouseClicked
        // SELECIONA O VALOR DA COLUNA CPF
        TableSelecionaClienteNovaConta.getValueAt(TableSelecionaClienteNovaConta.getSelectedRow(), 0);
    ...
    private void TextFildInserirSaldoInicialNovaContaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TextFildInserirSaldoInicialNovaContaActionPerformed
        // TODO add your handling code here:
        TextFildInserirSaldoInicialNovaConta.getText();
        // ainda não descobri como implementar
    ...
    private void ButtonSalvarNovaContaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonSalvarNovaContaActionPerformed
        ...
        boolean achou = false;
        for (int i = 0; i < ListaCliente.size(); i++) {
            if (TableSelecionaClienteNovaConta.getValueAt(TableSelecionaClienteNovaConta.getSelectedRow(), 0).equals(ListaCliente.get(i).getCPF())) {
                novaContaCliente = ListaCliente.get(i);
                achou = true;
                ButtonSalvarNovaConta.setEnabled( true );
                break;
            }
        }
        if (!achou) {
        ...
        c.adicionarConta(cb);
        Contas.add(cb);
        JOptionPane.showMessageDialog(rootPane, "Nova Conta cadastrada com sucesso.");
        RadioButtonSelecionaTipoContaCorrenteNovaConta.setSelected(false);
        RadioButtonSelecionaTipoContaPoupancaNovaConta.setSelected(false);
        TextFildInserirSaldoInicialNovaConta.setText("");
        ((DefaultTableModel) TableSelecionaClienteNovaConta.getModel()).setRowCount(0);
